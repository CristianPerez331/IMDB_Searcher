export const getTVShowsByTitleResponse = {
    "tv_results": [
        {
            "imdb_id":"tt2741602",
...
export const getTVShowDetailsByIdResponse = {
    "countries":[
    "USA",
    ],
    "creators":[
...
export const getTVShowImagesByIdResponse = {
    "IMDB":"tt2741602",
...
export const emptyGetTVShowsByTitleResponse = {
    search_results: 0,
    status: 'OK',
    status_message: 'Query was successful'
}
